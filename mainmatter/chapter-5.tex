...
The approach is design-first and simulation-first. Candidate concepts are traded off, then the selected design is advanced and analysed with thermomechanical and structural simulation before any physical prototyping. PLASMO is a paper study, so experimental work stays at conceptual or proof-of-concept level.
...
\textbf{Activity 2.1, ESATAN thermal cases.} Orbital thermal cases for the \qty{300}{\kilo\meter} VLEO baseline, including eclipse cycling, with the cooled detector carried as a fixed boundary condition. The output is the temperature field and the gradients across the deployed structure over an orbit.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{XXX}
        ...
        \midrule
        ESATAN licence access not yet confirmed & Blocks the phase-2 thermal chain & Confirm access before the midterm; a Python lumped-node thermal model is the fallback for first-order cases \\
